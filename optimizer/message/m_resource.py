...
class M_Resource(BaseItem):
    ...
    def token_descriptions(self):
        if self.mode51():
            return  ['res_kind', 'res', 'res_group', 'cal', 'BelGr', 'intensity', '', 'is_bottleneck', 'intensity_ovl',
                     'place', 'waiting_time', 'waiting_timeunit', 'capacity_weight_factor']
                # , 'SetupRvt', 'IntOvl', 'IntIgn'] not in 5.1 available
        return ['res_kind', 'res', 'res_group', 'cal', 'BelGr', 'intensity', 'res_type', 'is_bottleneck', 'is_possible_ovl',
                'place', 'waiting_time', 'waiting_timeunit', 'capacity_weight_factor', 'is_setup_relevant (unused)', 'intensity_ovl',
                'unlimited_intensity', 'buffer_time', 'buffer_time_unit', 'buffer_bound', 'setup_matrix_id']
